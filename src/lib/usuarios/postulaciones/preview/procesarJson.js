/**
 * procesarJson.js - Modulo autocontenido de parseo de CV a formato JSON estructurado
 * Utiliza Gemini API para convertir textos crudos o PDFs en un JSON estandar para Workwii.
 */
...
Por favor, extrae, traduce si es necesario y estructura en el formato JSON requerido.`;
  ...
  // Agregar IDs unicos a experiencias, educacion, etc. para renderizado reactivo
