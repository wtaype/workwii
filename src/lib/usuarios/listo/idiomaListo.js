...
export const idiomaListo = {
  es: {
    ...
    'list.editor.reconocimientos': 'Reconocimientos',
    'list.editor.agregarReconocimiento': '+ Agregar Reconocimiento',
    'list.editor.recTitulo': 'Título / Reconocimiento',
    'list.editor.recEmisor': 'Emisor / Organización',
    'list.editor.recFecha': 'Fecha (ej: Octubre 2024)',
    'list.editor.recUbicacion': 'Ubicación (ej: Lima, Perú)',
    'list.editor.recDesc': 'Descripción / Detalle del logro',
    'list.editor.recEnlace': 'Enlace de referencia (URL)',
    'list.editor.referencias': 'Referencias Laborales',
    'list.editor.agregarReferencia': '+ Agregar Referencia',
    'list.editor.refNombre': 'Nombre del Referente',
    'list.editor.refCargo': 'Cargo',
    'list.editor.refEmpresa': 'Empresa / Institución',
    'list.editor.refTelefono': 'Teléfono',
    'list.editor.refEmail': 'Correo Electrónico',
    'list.editor.refRelacion': 'Relación / Detalle',
    'list.editor.seccionesExtra': 'Secciones Personalizadas',
    'list.editor.agregarSeccionExtra': '+ Agregar Sección Personalizada',
    'list.editor.secTitulo': 'Título de la Sección (ej: Voluntariado)',
    'list.editor.secContenido': 'Contenido / Detalle'
  },
  en: {
    // Header principal
    'list.titulo': 'Listo',
    ...
    'list.editor.reconocimientos': 'Honors & Awards',
    'list.editor.agregarReconocimiento': '+ Add Award / Recognition',
    'list.editor.recTitulo': 'Award / Recognition Title',
    'list.editor.recEmisor': 'Issuer / Organization',
    'list.editor.recFecha': 'Date (e.g. October 2024)',
    'list.editor.recUbicacion': 'Location (e.g. Lima, Peru)',
    'list.editor.recDesc': 'Description / Achievement Detail',
    'list.editor.recEnlace': 'Reference Link (URL)',
    'list.editor.referencias': 'References',
    'list.editor.agregarReferencia': '+ Add Reference',
    'list.editor.refNombre': 'Reference Name',
    'list.editor.refCargo': 'Job Title',
    'list.editor.refEmpresa': 'Company / Institution',
    'list.editor.refTelefono': 'Phone',
    'list.editor.refEmail': 'Email',
    'list.editor.refRelacion': 'Relationship / Note',
    'list.editor.seccionesExtra': 'Custom Sections',
    'list.editor.agregarSeccionExtra': '+ Add Custom Section',
    'list.editor.secTitulo': 'Section Title (e.g. Volunteering)',
    'list.editor.secContenido': 'Content / Details'
  }
};
